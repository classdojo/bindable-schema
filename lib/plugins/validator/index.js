  ...
  Validator = (function(_super) {
    ...
    */
    ...
    Validator.prototype.schema = function(schema) {
      ...
      schema.validate = function(context, next) {
        var _ref1;

        return schema.root.validate(context, (_ref1 = context != null ? typeof context.toJSON === "function" ? context.toJSON() : void 0 : void 0) != null ? _ref1 : context, next);
      };
      return schema.validateField = function(path, context, next) {
