...
(function() {
  ...
  TestValidator = (function(_super) {
    ...
    */
    ...
    TestValidator.prototype.validate = function(model, next) {
      var onTest, value,
        _this = this;
      ...
      return this._test.call(model, String(value), onTest);
    };
    ...
    */
    ...
    TestValidator.create = function(options) {
      return new TestValidator(options);
    };
