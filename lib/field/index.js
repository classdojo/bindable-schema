  ...
  */
  ...
  Field = (function(_super) {
    ...
    */
    ...
    Field.prototype.child = function(path, closest) {
      if (closest == null) {
        closest = false;
      }
    ...
    */
    ...
    Field.prototype.setupModel = function(model) {
      var child, _i, _len, _ref, _results;

      this.emit("setupModel", model);
      _ref = this.fields;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        child = _ref[_i];
        _results.push(child.setupModel(model));
      }
      return _results;
    };
    ...
    */
    ...
    Field.prototype.addField = function(fieldName, options) {
      ...
      this.fields.push(field = new Field(options, this.schema));
