  ...
  */
  ...
  Field = (function(_super) {
    ...
    */
    ...
    function Field(plugins, options) {
      var _ref;
    ...
    */
    ...
    Field.prototype.attach = function(target, fields) {
      var field, _i, _len, _ref, _results;

      this.plugins.attach(target, info, this);
      _ref = this.fields;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        field = _ref[_i];
        _results.push(field.attach(target));
      }
      return _results;
    };
    ...
    */
    ...
    Field.prototype.addField = function(fieldName, options) {
      ...
      this.fields.push(field = new Field(this.plugins, options));
  ...
  module.exports = function(schema, options) {
    ...
    return new Field(schema, normalize(options));
  };
